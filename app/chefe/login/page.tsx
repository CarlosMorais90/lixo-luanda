...
export default function PaginaLoginChefe() {
  ...
  const entrar = async () => {
    ...
    try {
      ...
      if (!perfil || !['chefe', 'gestor'].includes(perfil.perfil)) {
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }}>
          ...
          <p style={{ margin: '8px 0 0', fontSize: '14px', color: '#6b7280' }}>
            Gestão de rotas e relatórios
          </p>
          <div style={{ width: '40px', height: '3px', background: '#1e40af', borderRadius: '99px', margin: '16px auto 0' }} />
        </div>
        ...
        <button
          ...
          style={{
            ...
            background: carregando ? '#9ca3af' : '#1e40af',
